...
# convert metadata to df form
ddsColData <- metaData  %>%
  mutate(sample_name = factor(paste0(hash.ID,"_",feature_gene)),
         feature_gene_organ = factor(paste0(feature_gene,"_",organ))) %>%
  as.data.frame() 
...
p5 <- DESeq2::plotPCA(ddsNorm2, intgroup = "median_sgRNA_umi", ntop=2000) +
  ...
  scale_color_viridis() +
  ggtitle("Pseudobulk by Median sgRNA UMI")
p6 <- DESeq2::plotPCA(ddsNorm2, intgroup = "mean_nCountRNA", ntop=2000) +
  theme(aspect.ratio = 1) +
  scale_color_viridis() +
...
write_csv(comparisonTib1,"analysis_outs/pseudobulk_mixscapeKO_ifngr1_spleen_mLN_DEG.csv")
...
write_csv(comparisonTib1,"analysis_outs/pseudobulk_mixscapeKO_ifngr1_CD62Lpos_neg_DEG.csv")
...
write_csv(comparisonTib1,"analysis_outs/pseudobulk_mixscapeKO_tgfbr2_spleen_mLN_DEG.csv")
...
write_csv(comparisonTib1,"analysis_outs/pseudobulk_mixscapeKO_tgfbr2_CD62Lpos_neg_DEG.csv")
